<?php 
	...
	$requete = "UPDATE Client SET nom_client=? ,nom_jeune_fille=? ,prenom_client=? ,email_client=? ,tel_client=? ,ville=? ,code_postal=? ,date_naissance_client=? ,securite_sociale=? ,cmu=? ,ame=? ,vous_savez_pas_beneficiaire=? ,diabete=? ,embolie_pulmonaire_phlebite=? ,hypertention_arterielle=? ,probleme_cardiaques=? ,diagnostic_precedente=? ,fausses_couche_4=? ,cerclage_col=? ,menace_AP=? ,diabete_gestationel=? ,hypertension_arterielle_precedent=? ,pre_eclampsie=? ,hemotagie_delivrance=? ,hra=? ,cerclage_col_actuelle=? ,menace_ap_actuelle=? ,diabete_gestationel_actuelle=? ,hypertension_arterielle_actuelle=? ,pre_eclampsie_actuelle=? ,commentaire_autre_maladie=? ,commentaire_grossesse_precedente=? ,prise_charge_grossesse_actuelle=? ,quelle_pathologie=? ,commentaire_grossesse_actuelle=? ,traitement_actuel=? ,drepanocytose=? ,depression=? ,medicament_deperession=? ,nb_accouchement=? ,avez_accouche_SHPH=? ,date_accouchement_SHPH=? ,avez_vous_des_fausses_couches=? ,nombre_fausse_couche=? ,accouchement_avant_8_mois=? ,preciser_terme=? ,prise_en_charge_neonatalogie_mois=? ,ac_avant_8_mois_poid_bb=? ,cesarienne=? ,nb_bb=? ,date_accouchement_prevue=? ,date_debut_grossesse=? WHERE id_client=? ";
	$params = array($nom_client,$nom_jeune_fille,$prenom_client,$email_client,$tel_client,$ville,$code_postal,$date_naissance_client,$securite_sociale,$cmu,$ame,$vous_savez_pas_beneficiaire,$diabete,$embolie_pulmonaire_phlebite,$hypertention_arterielle,$probleme_cardiaques,$diagnostic_precedente,$fausses_couche_4,$cerclage_col,$menace_AP,$diabete_gestationel,$hypertension_arterielle_precedent,$pre_eclampsie,$hemotagie_delivrance,$hra,$cerclage_col_actuelle,$menace_ap_actuelle,$diabete_gestationel_actuelle,$hypertension_arterielle_actuelle,$pre_eclampsie_actuelle,$commentaire_autre_maladie,$commentaire_grossesse_precedente,$prise_charge_grossesse_actuelle,$quelle_pathologie,$commentaire_grossesse_actuelle,$traitement_actuel,$drepanocytose,$depression,$medicament_deperession,$nb_accouchement,$avez_accouche_SHPH,$date_accouchement_SHPH,$avez_vous_des_fausses_couches,$nombre_fausse_couche,$accouchement_avant_8_mois,$preciser_terme,$prise_en_charge_neonatalogie_mois,$ac_avant_8_mois_poid_bb,$cesarienne,$nb_bb,$date_accouchement_prevue,$date_debut_grossesse,$id_client);
