	...
	<body>
		<div id="contenair">
			...
			<div id="demande_formulaire">
				...
				<div id="formulaire">
					<form method="POST" action="connexionBD.php" enctype="multipart/form-data">
						<h2>Votre Contact</h2>
						...
						<div id="information-cocher">
							...
							<div class="form-3">
								<input type="checkbox" id="securité_soial" name="1"> <!-- ici j'ai chager le name a cause du INT dans le mysql-->
  								<label for="1">De la Securé social</label><br>
