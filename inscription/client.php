			...
			<div class="card bg-light text-dark">
				<div class="card-body">
					<form method="GET" action="client.php" class="form-inline">
						...
						&nbsp &nbsp
						<a href="ajouterClient.php"><span class="fa fa-pencil"> Ajouter un Client</a>
					</form>
				</div>
			</div>
			...
			<div class="card bg-light text-dark">
				<div class="card-body">
					<table class="table table-striped table-bordered">
						<thead>
							<tr>
								<th>Id client</th><th>nom client</th><th>Prenom client</th><th>Date de début de grossesse</th><th>Date accouchement prévue</th><th>Action</th>
							</tr>
						</thead>
						<tbody>
