	...
	<body>
		<div id="contenair">
			...
			<div id="demande_formulaire">
				...
				<div id="formulaire">
					<form method="POST" action="/phpCour/target.php">
						<h2>Votre Contact</h2>
						...
						<div id="information-cocher">
							...
							<p><strong>Avez vous poue antecedents medicaux ou etes-vous suivie pour uen maladie chronique?</strong></p>
							<div class="form-4">
								...
								<label for="pet-select">Dépression:</label>
								...
								<div class="depression_oui">								
									<label for="depression_oui">Si vous etes depressive quel medicament vous prenez :</label>
									<input type="text" name="depression_oui" id="depression_oui" disabled><br>
								</div>
							...
							<div class="form-6">
								...
								<div class="depression_oui">
									<input type="checkbox" name="avez_vous_accou_oui" id="avez_vous_accou_oui">
									<label for="avez_vous_accou"><strong>NON</strong> (ou)</label>
									<input type="checkbox" name="avez_vous_accou_non" id="avez_vous_accou_non">
							...
							<div class="form-7">
								...
								<div class="depression_oui">
									<input type="radio" name="personelle_CSHSF_non" id="personelle_CSHSF_non">
									<label for="personelle_CSHSF_non"><strong>NON</strong> (ou)</label>
									<input type="checkbox" name="personelle_CSHSF_oui" id="personelle_CSHSF_oui">
						...
						<div id="grosesses_precedente">
							<input type="checkbox" name="diagnostic_antenatal" id="diagnostic_antenatal">
							<label for="diagnostic_antenatal"><strong> Prise en charge au diagnostic anténatal</strong></label>
							<div class="depression_oui">
								<input type="radio" name="syndrone_malformatif" id="syndrone_malformatif">
								<label for="syndrone_malformatif">Syndrome malformatif </label><br>
								<input type="radio" name="mort_fœtale" id="mort_fœtale">
								<label for="mort_fœtale">Mort fœtale in utéro </label><br>
								<input type="radio" name="iso-immunisation_rhésuss" id="iso-immunisation_rhésuss">
							...
							<label for="avez_vous_accou_F"><strong> Avez-vous déjà fait des Fausses couches? </strong></label>
								<div class="depression_oui">
									<input type="checkbox" name="avez_vous_accou_F_non" id="avez_vous_accou_F_non">
									<label for="avez_vous_accou_F_non"><strong>NON</strong> (ou)</label>
									<input type="checkbox" name="avez_vous_accou_F_oui" id="avez_vous_accou_oui">
							...
							<input type="checkbox" name="ac_avant_8_mois" id="ac_avant_8_mois">
							<label for="ac_avant_8_mois"> Accouchement avant le 8ème mois:<strong> préciser le terme</strong></label>
							<input type="number" name="preciser_terme" id="preciser_terme">
							<div class="depression_oui">
							...
							<label for="avez_vous_accou_F"><strong>Césarienne(s) </strong></label>
								<div class="depression_oui">
									<input type="checkbox" name="cesarienne_non" id="cesarienne_non">
									<label for="cesarienne_non"><strong>NON</strong> (ou)</label>
									<input type="checkbox" name="cesarienne_oui" id="cesarienne_oui">
							...
							<label for="autre_precision"><strong>Si Vous Avez autre (preciser) ?</strong></label><br/>
       						<textarea name="autre_precision" id="autre_precision"></textarea>
						</div>
						<h2>Grossesse actuelle</span></h2>
						<div id="grosesses_actuelle">
							...
							<div class="depression_oui">
								...
								<input type="radio" name="gemellaire" id="gemellaire">
								<label for="gemellaire">Gemellaire </label><br>
								<input type="radio" name="triple" id="triple">
						...
						<div id="suivi_grossesse">
							...
							<label for="prise_charge"> Prise en charge au diagnostic anténal :</label>
							<div class="depression_oui">
								<label for="pathologie">Pour quelle pathologie ?</label><br/>
       							<textarea name="pathologie" id="pathologie"></textarea>
							</div>
							...
							<label for="autre_precision_actuelle"> Autre (à préciser)</label><br/>
       						<textarea name="autre_precision_actuelle" id="autre_precision_actuelle"></textarea>
       						<br>
       						<label for="traitement_actuelle"> <strong>Traitement actuel :</strong></label><br/>
       						<textarea name="traitement_actuelle" id="traitement_actuelle"></textarea>
       						<br>
       						<label for="nom-sagefemme"> <strong>Nom du médecin ou de la sage-femme qui suit votre grossesse :</strong></label><br/>
       						<textarea name="nom-sagefemme" id="nom-sagefemme"></textarea>
       						<br>
						</div>
						<br>
